...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder>{
    ...
    public UsersRecyclerAdapter(Context context, ArrayList<UserItem> usersItemArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        UserItem users = usersItemArrayList.get(position);

        holder.textName.setText("Name : " + users.getUserName());
        holder.textDes.setText("Des : " + users.getDes());
        holder.textDate.setText("Date : " + users.getpDate());

        holder.buttonUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ViewDialogUpdate viewDialogUpdate = new ViewDialogUpdate();
                viewDialogUpdate.showDialog(context,users.getUserID(),users.getUserName(),users.getDes(),users.getpDate());
            }
        });
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || des.isEmpty() || date.isEmpty()) {
                        ...
                        if (newName.equals(name) && newDes.equals(des) && newDate.equals(date)) {
                            ...
                            databaseReference.child("USERS").child(id).setValue(new UserItem(id, newName, newDes, newDate));
